...
namespace LandABI.Contracts.Land.ContractDefinition
{
    ...
    public partial class LandDeployment : LandDeploymentBase
    {
        public LandDeployment() : base(BYTECODE) { }
        public LandDeployment(string byteCode) : base(byteCode) { }
    }

    public class LandDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "0x";
        public LandDeploymentBase() : base(BYTECODE) { }
        public LandDeploymentBase(string byteCode) : base(byteCode) { }
    ...
    public partial class GetBuildingsFunction : GetBuildingsFunctionBase { }

    [Function("getBuildings", "uint256[]")]
    public class GetBuildingsFunctionBase : FunctionMessage
    {

    }

    public partial class GetMetaDataFunction : GetMetaDataFunctionBase { }

    [Function("getMetaData", typeof(GetMetaDataOutputDTO))]
    public class GetMetaDataFunctionBase : FunctionMessage
    {
    ...
    public partial class GetBuildingsOutputDTO : GetBuildingsOutputDTOBase { }

    [FunctionOutput]
    public class GetBuildingsOutputDTOBase : IFunctionOutputDTO
    {
        [Parameter("uint256[]", "", 1)]
        public virtual List<BigInteger> ReturnValue1 { get; set; }
    }

    public partial class GetMetaDataOutputDTO : GetMetaDataOutputDTOBase { }

    [FunctionOutput]
    public class GetMetaDataOutputDTOBase : IFunctionOutputDTO
    {
        [Parameter("tuple", "", 1)]
        public virtual Metadata ReturnValue1 { get; set; }
    }
